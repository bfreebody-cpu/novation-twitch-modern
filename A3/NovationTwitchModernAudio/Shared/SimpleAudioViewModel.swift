...
class SimpleAudioViewModel: NSObject {
	...
	public var dextLoadingState: String {
		switch state {
		case .unloaded:
			return "Novation Twitch Modern Audio isn't loaded."
		case .activating:
			return "Activating Novation Twitch Modern Audio, please wait."
		case .needsApproval:
			return "Please follow the prompt to approve Novation Twitch Modern Audio."
		case .activated:
			return "Novation Twitch Modern Audio has been activated and is ready to use."
		case .activationError:
			return "Novation Twitch Modern Audio has experienced an error during activation.\nPlease check the logs to find the error."
		}
	}
}
